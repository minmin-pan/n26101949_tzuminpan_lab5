...
class TowerGroup:
    ...
    def upgrade(self):
        ...
        if self.selected_tower.level < 5:       # level can not exceed 5
            self.selected_tower.level += 1
        else:                                   # exceed 5 then not do anything
            pass
        pass
    ...
    def sell(self):
        ...
        self.__towers.remove(self.selected_tower)   # remove tower you choice
        self.selected_tower = None                  # clean menu
        pass
